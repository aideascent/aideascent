...
@section('admin_content')
    ...
    <form action="{{ url('admin/product-subcategory/update/'.$category->id) }}" method="post">
        @csrf
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 mt-2 font-weight-bold text-primary">Edit Sub Category</h6>
                <div class="float-right d-inline">
                    <a href="{{ route('admin.productsubcategory.index') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> View All</a>
                </div>
            </div>
            <div class="card-body">
				...
				<div class="form-group"> 
						<label for="parent">Parent Category</label>
							...
							<option value="0">None</option>
								<?php
									echo \App\Models\Admin\ProductCategory::printTree($tree, 0, null, @$category->parent);
								?>
							</select>
