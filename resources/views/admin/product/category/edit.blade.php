...
@section('admin_content')
    ...
    <form action="{{ url('admin/product-category/update/'.$category->id) }}" method="post">
        @csrf
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 mt-2 font-weight-bold text-primary">Edit Product Category</h6>
                <div class="float-right d-inline">
                    <a href="{{ route('admin.productcategory.index') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> View All</a>
                </div>
            </div>
            <div class="card-body">
