...
@section('admin_content')
    ...
    <form action="{{ route('admin.servicesubcategory.store') }}" method="post">
        @csrf
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 mt-2 font-weight-bold text-primary">Add Sub Category</h6>
                <div class="float-right d-inline">
                    <a href="{{ route('admin.servicesubcategory.index') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> View All</a>
                </div>
            </div>
            <div class="card-body">
				...
				<div class="form-group"> 
						<label for="parent">Parent Category</label>
							...
							<option value="0">None</option>
								<?php
									echo \App\Models\Admin\ServiceCategory::printTree($tree);
								?>
							</select>
