...
@section('admin_content')
    ...
    <form action="{{ url('admin/subscriber-subcategory/update/'.$category->id) }}" method="post">
        @csrf
				...
				<div class="form-group"> 
						<label for="parent">Parent Category</label>
							...
							<option value="0">None</option>
								<?php
									echo \App\Models\Admin\SubscriberCategory::printTree($tree, 0, null, @$category->parent);
								?>
							</select>
