...
@section('admin_content')
    <h1 class="h3 mb-3 text-gray-800">Add Sub Category</h1>

    <form action="{{ route('admin.subscribersubcategory.store') }}" method="post">
        @csrf
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 mt-2 font-weight-bold text-primary">Add Sub Category</h6>
                <div class="float-right d-inline">
                    <a href="{{ route('admin.subscribersubcategory.index') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> View All</a>
                </div>
            </div>
            <div class="card-body">
				...
				<div class="form-group"> 
						<label for="parent">Parent Category</label>
							...
							<option value="0">None</option>
								<?php
									echo \App\Models\Admin\SubscriberCategory::printTree($tree);
								?>
							</select>
